...
**Spec:** [WCP_SPEC.md](WCP_SPEC.md)
**Production implementation:** [pip install pyhall](https://github.com/fafolab-ai/pyhall)

---

## What this is

This is the Go scaffolding for [WCP — Worker Class Protocol](WCP_SPEC.md), an open standard for governing worker dispatch in AI agent systems.
...
Read the full spec: [WCP_SPEC.md](WCP_SPEC.md)

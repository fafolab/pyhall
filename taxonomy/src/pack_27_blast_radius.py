...
ENTITIES = [
    ...
    },
    {
        ...
        'controls_required': ['ctrl.sandbox.no-egress-default-deny', 'ctrl.sandbox.path-allowlists', 'ctrl.blast-radius-scoring'],
        'wcp_namespace': 'reserved',
    },
    {
        ...
        'controls_required': ['ctrl.obs.audit-log-append-only', 'ctrl.blast-radius-scoring'],
        'wcp_namespace': 'reserved',
    },
    {
        ...
        'controls_required': ['ctrl.sandbox.no-egress-default-deny', 'ctrl.sandbox.secrets-denied-by-default', 'ctrl.privilege-envelopes-required'],
        'wcp_namespace': 'reserved',
    },
    {
        'id': 'pol.default-deny',
        ...
        'controls_required': ['ctrl.pol.default-deny', 'ctrl.pol.policy-engine-runtime', 'ctrl.blast-radius-scoring'],
        'wcp_namespace': 'reserved',
    },
]
